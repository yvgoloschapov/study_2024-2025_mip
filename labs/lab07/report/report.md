...
Построиние схемы суперблока, моделирующего поступление заявок (рис. [-@fig:001])

![Схема суперблока](image/01.jpg){#fig:001 width=70%}

Построиние схемы суперблока, моделирующего обработку заявок (рис. [-@fig:002]) 

![Схема суперблока](image/02.jpg){#fig:002 width=70%}

Вся модель системы и графики (рис. [-@fig:003])
